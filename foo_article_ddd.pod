...
Einteilung der umzusetzenden Anforderungen in kleinere Einheiten. Die
Struktutierung der erzeugten Klassen in Module, Pakete oder die Vergabe von
Namensräumen (je nach verwendeter Programmiersprache) wird ebenso abgedeckt.
